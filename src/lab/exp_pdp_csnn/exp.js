...
//Click here to see hinton diagrams is hit
...
//Onclick on the Click here for clamping descriptors page
...
function makeHinton()
{
    ...
    for (let i = 0; i < rowCount; i++) {
        for (let j = 0; j < columnCount; j++) {
            let t = (8 * i) + j;
            //fill(0);
            for (let in1 = 0; in1 < rowCount; in1++) {
                for (let ou1 = 0; ou1 < columnCount; ou1++) {
                    let dd = (8 * in1) + ou1;
...
//Hovering effect in the testing page 
    ...
    for (let i = 0; i < rowCount; i++) {
        for (let j = 0; j < columnCount; j++) {
            ...
            if (mouseX > drawX + 95 * j && mouseX < drawX + 95 * j + 85 && mouseY > drawY + 70 * i && mouseY < drawY + 70 * i + 50) {
                ...
                let t2 = (8 * i) + j;
                fill(0);
                for (let ou1 = 0; ou1 < rowCount; ou1++) {
                    stroke(30);
                    //          line(275, 495+18*out, 515, 495+18*out);
                    noStroke();
                    for (let in1 = 0; in1 < columnCount; in1++) {
                        stroke(30);
