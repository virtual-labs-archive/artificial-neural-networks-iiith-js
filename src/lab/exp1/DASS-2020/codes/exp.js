...
function setNewValues() {
  ...
  } else if (Number.isNaN(select("#estr_inp").value()) || Number.isNaN(select("#actmax_inp").value()) || Number.isNaN(select("#actmin_inp").value()) || Number.isNaN(select("#actrest_inp").value()) || Number.isNaN(select("#decay_inp").value()) || Number.isNaN(select("#beta_inp").value()) || Number.isNaN(select("#gamma_inp").value())) {
